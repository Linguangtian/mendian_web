...
Page({
    ...
    handleTap: function(a) {
        ...
        if ("object" != _typeof(this.data.actcatas)) {
            if (this.data.actcatas = new Array(), void 0 === this.data.actcatas[t]) {
                this.data.actcatas[t] = 0, console.log(this.data.actcatas);
                var e = this;
                this.setData({
    ...
    changelist: function(a) {
        ...
        var o = a.target.dataset.index, c = a.target.dataset.id;
        console.log(a);
        var n = this.data.topcate, d = n[o].sons;
        if ("0" == c) n[o].title = n[o].varible; else for (s = 0; s < d.length; s++) if (d[s].id == c) {
            n[o].title = d[s].varible;
            break;
        }
        var l = e.data.actcatas;
        if ("object" != (void 0 === l ? "undefined" : _typeof(l)) && (e.data.actcatas = new Array()), 
        ...
        this.data.actcatas[o] = c, 1 == i && (this.data.pid[o] = t), this.setData({
            topcate: n,
            actcata: e.data.actcatas
        }), console.log(e.data.actcatas);
        var r = this, p = a.target.dataset.id, h = r.data.actcatas.join(",");
        app.util.request({
            url: "entry/wxapp/changelist",
            cachetime: "0",
            data: {
    ...
    getList: function() {
        ...
        app.util.request({
            ...
            success: function(a) {
                ...
                }), console.log(i.data.subcate), wx.setNavigationBarTitle({
