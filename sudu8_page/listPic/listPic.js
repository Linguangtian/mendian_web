...
Page({
        ...
        null == t && (t = u.data.cid), app.util.request({
            ...
            success: function(t) {
                ...
                2 == u.data.cateinfo.list_style_more) {
                    var a = u.data.options, e = wx.getStorageSync("systemInfo"), o = a;
    ...
    onReachBottom: function() {
        ...
        app.util.request({
            ...
            success: function(t) {
                console.log(t), "" != t.data.data.list ? a.setData({
    ...
    tiaozhuang: function(t) {
        var a = t.currentTarget.dataset.id, e = t.currentTarget.dataset.types, o = t.currentTarget.dataset.ismore, i = "";
        console.log(e), console.log(o), "showPro" == e ? (0 == o && (console.log(1), i = "/sudu8_page/showPro/showPro?id=" + a), 
        1 == o && (console.log(2), i = "/sudu8_page/showPro_lv/showPro_lv?id=" + a)) : (console.log(3), 
        i = "/sudu8_page/" + e + "/" + e + "?id=" + a), wx.navigateTo({
            url: i
        });
    }
});