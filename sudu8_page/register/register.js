...
Page({
    ...
    onLoad: function(a) {
        var t = this;
        t.refreshSessionkey(), a.from && (t.data.from = a.from), wx.setNavigationBarTitle({
            title: "开卡"
    ...
    getPhoneNumber: function(a) {
        var t = this, e = a.detail.iv, n = a.detail.encryptedData;
        "getPhoneNumber:ok" == a.detail.errMsg ? wx.checkSession({
            success: function() {
                app.util.request({
                    ...
                    success: function(a) {
                        console.log(a.data), a.data.data ? t.setData({
    ...
    choiceimg1111: function(a) {
        ...
        e ? t = e.length : (t = 0, e = []);
        var s = n - t, l = app.util.url("entry/wxapp/wxupimg", {
            m: "sudu8_page"
    ...
    riqi: function() {
        ...
        var o = [], i = [], d = new Date();
        for (s = 0; s < 5; s++) {
            var r = new Date(d.getTime() + 24 * s * 3600 * 1e3), l = r.getFullYear(), c = r.getMonth() + 1, u = r.getDate(), g = c + "月" + u + "日", h = l + "-" + c + "-" + u;
            o.push(g), i.push(h);
        }
        this.setData({
            arrs: o,
