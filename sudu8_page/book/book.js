...
Page({
    ...
    getbaseinfo: function() {
        ...
        app.util.request({
            ...
            cachetime: "30",
            success: function(t) {
                var a = t.data.data, e = t.data.data.single_v, o = t.data.data.checkbox_v, n = t.data.data.s2.s2v, i = t.data.data.c2.c2v, s = new Array(), r = new Array(), d = new Array(), l = new Array();
                s = e ? e.split(",") : "无", r = n ? n.split(",") : "无", d = o ? o.split(",") : "无", 
                l = i ? i.split(",") : "无", "pic" == a.forms_head && f.setData({
                    forms_head_con: WxParse.wxParse("forms_head_con", "html", a.forms_head_con, f, 0)
                }), f.setData({
                    formsConfig: a,
                    single_v: s,
                    checkbox_v: d,
